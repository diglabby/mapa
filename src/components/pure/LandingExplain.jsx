...
const LandingExplain = props => {
  ...
  return (
    <div>
      ...
      <div className="gray">
        <div className="content-wrapper">
          <h2 id="goals" ><strong>{t("landingExplain.chapter2.heading")}</strong></h2>
      ...
      <div className="gray">
        <div className="content-wrapper">
          <h2 id="principles" ><strong>{t("landingExplain.chapter4.heading")}</strong></h2>
      ...
      <div className="gray">
        <div className="content-wrapper">
          <h2><strong>{t("landingExplain.howTo.title")}</strong></h2>
      ...
      <div className="white">
        <div className="content-wrapper">
          <h2 id="team" ><strong>{t("landingExplain.chapter6.heading")}</strong></h2>
          <div className="pure-g" style={{ marginTop: "60px" }}>
      ...
      <div className="gray">
        <div className="content-wrapper">
          <h2><strong>{t("landingExplain.chapter7.heading")}</strong></h2>
      ...
      <div className="white">
        <div className="content-wrapper">
          <h2 id="partners"><strong>{t("landingExplain.chapter9.heading")}</strong></h2>
      ...
      <div className="gray">
        <div className="content-wrapper">
          <h2 id="contacts"><strong>{t("landingExplain.chapter10.heading")}</strong></h2>
          <div className="pure-g" style={{ marginTop: "60px" }}>
